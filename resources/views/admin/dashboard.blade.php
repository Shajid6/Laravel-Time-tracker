    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    <span class="info-box-icon bg-info"><i class="ui icon user circle"></i></span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    <span class="info-box-icon bg-success"><i class="ui icon clock outline"></i></span>
                    <div class="info-box-content">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    <span class="info-box-icon bg-danger"><i class="ui icon home"></i></span>
                    <div class="info-box-content">
