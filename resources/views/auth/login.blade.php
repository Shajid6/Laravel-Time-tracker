		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center "><img class="ll" src="{{ asset('/assets/images/img/logo2.png') }}" alt="Workday" style="background: black; padding:15px; border-radius:50px; width:100px;"></div>
